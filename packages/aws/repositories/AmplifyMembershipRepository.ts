  ...
  implements MembershipRepository<MembershipEntity>
{
  ...
  public findById = async (id: string): Promise<MembershipEntity | null> => {
  ...
  public update = async (id: string, entity: Partial<MembershipEntity>): Promise<MembershipEntity> => {
  ...
  public findByOrganization = async (orgId: string): Promise<MembershipEntity[]> => {
    const response =
      await this.dbClient.models.Membership.listMembershipByOrgId({ orgId });
    return response.data.map((item: any) => this.toMembership(item));
  };

  public findByAccount = async (accountId: string): Promise<MembershipEntity[]> => {
  ...
  public findByAccountAndOrganization = async (
    accountId: string,
    orgId: string
